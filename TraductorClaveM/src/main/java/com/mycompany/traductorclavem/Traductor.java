...
//---Menu de opciones-----
    ...
    frase = palabra1.toCharArray();
    palabraConvertida = new char[longitud];
    
    for(int i = 0; i<longitud;i++){
    if(frase[i] == 'M'){
    palabraConvertida[i] = murcielago[0];
    } else if(frase [i] == 'U'){
        palabraConvertida[i] = murcielago[1];
    } else if(frase [i] == 'R'){
        palabraConvertida[i] = murcielago[2];
    } else if(frase [i] == 'C'){
        palabraConvertida[i] = murcielago[3];
    } else if(frase [i] == 'I'){
        palabraConvertida[i] = murcielago[4];
    } else if(frase [i] == 'E'){
        palabraConvertida[i] = murcielago[5];
    } else if(frase [i] == 'L'){
        palabraConvertida[i] = murcielago[6];
    } else if(frase [i] == 'A'){
        palabraConvertida[i] = murcielago[7];
    } else if(frase [i] == 'G'){
        palabraConvertida[i] = murcielago[8];
    } else if(frase [i] == 'O'){
        palabraConvertida[i] = murcielago[9];
    } else{
        palabraConvertida[i] = frase[i];
    }
...
public void traductor(){
    for (int i=0;i<longitud;i++){
        System.out.println(palabraConvertida[i] + "");
    }
    }
    ...
    private void initComponents() {
        ...
        jLabel_titulo1.setFont(new java.awt.Font("Berlin Sans FB", 0, 18)); // NOI18N
        jLabel_titulo1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_titulo1.setText("Traductor clave murcielago ");

        jLabel_texto1.setFont(new java.awt.Font("Bell MT", 0, 14)); // NOI18N
        jLabel_texto1.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txt_longitud.setForeground(new java.awt.Color(255, 255, 255));
        txt_longitud.setText("Longitud del texto..... :");

        txt_totalP.setForeground(new java.awt.Color(255, 255, 255));
        txt_totalP.setText("Total de palabras....... :");

        txt_primeraL.setForeground(new java.awt.Color(255, 255, 255));
        txt_primeraL.setText("Primera letra del texto..:");

        txt_ultimaL.setForeground(new java.awt.Color(255, 255, 255));
        txt_ultimaL.setText("Última letra del texto... :");

        txt_Lcentral.setForeground(new java.awt.Color(255, 255, 255));
        txt_Lcentral.setText("Letra central del texto. :");

        txt_primeraP.setForeground(new java.awt.Color(255, 255, 255));
        txt_primeraP.setText("Primera palabra......... :");

        txt_palabraC.setForeground(new java.awt.Color(255, 255, 255));
        txt_palabraC.setText("Palabra Central......... :");

        txt_ultimaP.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txt_repeticionesA.setForeground(new java.awt.Color(255, 255, 255));
        txt_repeticionesA.setText("Repeticiones de \"A\", \"a\" ó \"á\"..........:");

        txt_repeticionesE.setForeground(new java.awt.Color(255, 255, 255));
        txt_repeticionesE.setText("Repeticiones de \"E\", \"e\" ó \"é\"......... :");

        txt_repeticionesI.setForeground(new java.awt.Color(255, 255, 255));
        txt_repeticionesI.setText("Repeticiones de \"I\", \"i\" ó \"í\"............:");

        txt_repeticionesO.setForeground(new java.awt.Color(255, 255, 255));
        txt_repeticionesO.setText("Repeticiones de \"O\", \"o\" u \"ó\"........ :");

        txt_repeticionesU.setForeground(new java.awt.Color(255, 255, 255));
        txt_repeticionesU.setText("Repeticiones de \"U\", \"u\" ó \"ú\"........ :");

        txt_palabrasPar.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txt_palabrasImpar.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txt_traduccion.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jDesktopPane1.setLayer(jLabel_titulo1, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jDesktopPane1Layout.setHorizontalGroup(
            ...
            .addGroup(jDesktopPane1Layout.createSequentialGroup()
                ...
                .addGroup(jDesktopPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jDesktopPane1Layout.createSequentialGroup()
                        ...
                        .addComponent(txt_traduccion, javax.swing.GroupLayout.PREFERRED_SIZE, 355, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(89, 89, 89))
                    .addGroup(jDesktopPane1Layout.createSequentialGroup()
                    ...
                    .addGroup(jDesktopPane1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jDesktopPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(lbl_repeticionesA, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE)
                            .addComponent(lbl_palabrasImpar, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbl_palabrasPar, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbl_repeticionesU, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbl_repeticionesO, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbl_repeticionesI, javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jDesktopPane1Layout.createSequentialGroup()
                ...
                .addGroup(jDesktopPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jDesktopPane1Layout.createSequentialGroup()
                        .addComponent(jLabel_titulo1, javax.swing.GroupLayout.PREFERRED_SIZE, 255, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(131, 131, 131))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jDesktopPane1Layout.createSequentialGroup()
                        .addComponent(jLabel_titulo2, javax.swing.GroupLayout.PREFERRED_SIZE, 355, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(86, 86, 86))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jDesktopPane1Layout.createSequentialGroup()
                        .addComponent(btn_Procesar, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(201, 201, 201))))
        );
        jDesktopPane1Layout.setVerticalGroup(
            jDesktopPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jDesktopPane1Layout.createSequentialGroup()
                .addComponent(jLabel_titulo1, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel_titulo2, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addComponent(btn_Procesar, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jDesktopPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jDesktopPane1Layout.createSequentialGroup()
                    ...
                    .addGroup(jDesktopPane1Layout.createSequentialGroup()
                        ...
                        .addGroup(jDesktopPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(txt_palabrasImpar))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txt_traduccion, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTextField_traductor, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_ProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ProcesarActionPerformed
        // TODO add your handling code here:
        String palabra = jTextArea_Ingreso.getText();
       ...
       lbl_palabrasPar.setText(Integer.toString(sumPar));
       lbl_palabrasImpar.setText(Integer.toString(sumImp));
